...
addElement.addEventListener('click', (e) => {
  ...
  if (elementoTarefaEditada) {
    ...
    let obj = adicionarBackend(valor);
...
function concluirTarefa(e) {
  ...
  if (ehTarefaConcluída) {
    desfazerTarefaBackend(lookupId);
  } else {
    concluirTarefaBackend(lookupId);
  }
